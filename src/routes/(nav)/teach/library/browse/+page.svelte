...
<div class='container page'>
  ...
  <section>
    ...
    <div class='collections'>
      ...
      <article>
        ...
        <p>{collection.short}</p>
        <div class='buttons'>
          <a role="button" href="/teach/library/browse/{collection.element.path}">View Collection</a>
        </div>
      </article>
      {/each}
      {:else}
  ...
  <section>
    ...
    <ElementTable filters={data.filters} session={data.session} elements={data.elements} user={data.user} />
  </section>
</div>
