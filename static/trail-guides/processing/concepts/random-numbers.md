...
:::quick-take{src="TODO.gif"}
Use the `random()` method to have the computer generate a random number, then use the `=` operator to store it in a variable so the computer can use it later:
