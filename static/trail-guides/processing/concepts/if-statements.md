...
:::quick-take{src="TODO"}
Use "if" statements to give the computer sections of code to either execute or skip based on the `boolean` value in the parentheses (this value is often written as a **relational** or **logical** expression):
