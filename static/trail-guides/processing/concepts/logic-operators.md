...
short:
long: Learn how to combine relational expressions and Boolean values to create complex conditional statements, controlling how the computer makes decisions as it runs your program.
video: https://youtube.com/embed/Mu8VDPhdPdw
---

:::quick-take{src="TODO"}
Use logic operators to combine relational expressions, creating more complex conditional statements:
...
void draw() {
	background(255);
	text(mouseX >= 25 && mouseX <= 75)
}
```

Here is a table of all the logic operators you can use in Java:
