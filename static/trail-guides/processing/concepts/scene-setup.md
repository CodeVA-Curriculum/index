...
:::quick-take{src="basic-scene.png"}
All the code that you want the computer to execute *once*, right when you click `Play`, should be written in the `setup()` method. Use the `size(w,h)` method to set the size of the application window.
