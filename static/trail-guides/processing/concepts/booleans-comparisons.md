...
:::quick-take{src="TODO"}
Use relational operators to have the computer compare two values of the same data type and produce a value of either `true` or `false`:
...
void draw() {
	background(255);
	text(mouseX <= 50, 50, 50);
}
```

Here's a table of all the relational operations you can use in Java:
