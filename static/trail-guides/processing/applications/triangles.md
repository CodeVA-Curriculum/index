...
long: In this tutorial, you'll learn how to have the computer display triangles using Processing's `triangle()` method. This one is a little tricky because it involves locating three points independently of one another to create your desired shape.
short: Learn how to display triangles using the `triangle()` method
video: https://youtube.com/embed/Mu8VDPhdPdw
type: tutorial
---

:::quick-take{src="TODO below"}
Use the `triangle(x1,y1,x2,y2,x3,y3)` method to have the computer display a triangle shape on the canvas. The six parameters are three sets of coordinate pairs; each pair corresponds to the location of one of the points of the triangle on the canvas:
...
:::prompt{title="Activity 8"}
Use the image you created in the prompt for [./copy-scene.md] as a starting point and improve your design by adding triangles and using additional colors.
:::