...
:::code-and-image{name="Delay Example" src="delay-text-demo.gif"}
```
...
:::code-and-image{name="Delay with Continue" src="delay-in-situ.gif"}
```
You find yourself in a damp, dark cave. You hear water dripping from stalactites hanging above you.
...
:::code-and-image{name="Delay Append Example" src="delay-append-demo.gif"}
```
