...
:::code-and-image{name="If-Unless" src="if-unless-starter.png" tabs}
```treasure
hasKey: true
--
...
:::code-and-image{name="If-Else" src="if-unless-starter.png" tabs}
```treasure
hasKey: true
--
...
:::code-and-image{name="The Locked Chest" src="the-locked-chest.png" tabs}
```intro
hasKey: false
--
