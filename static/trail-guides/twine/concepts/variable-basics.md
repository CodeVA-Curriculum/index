...
:::code-and-image{name="Variable Insert Example" src="var-insert.png"}
```
a_cool_message: "Hello!"
--
...
:::code-and-image{name="Reusing Variables" src="woodchuck.png"}
```
creature: "woodchuck"
material: "wood"
--
...
:::code-and-image{name="Number Variables" src="var-simple.png"}
```
age: 15
--
...
:::code-and-image{name="Boolean Variables" src="var-boolean.png"}
```
hasKey: true
--
