...
:::code-and-image{name="Goldilocks Version 1" src="goldilocks-intro.png" tabs}
```intro
kitchen: 'porridge'
...
:::code-and-image{name="Goldilocks Version 2" src="goldilocks2-demo.gif" tabs}
```kitchen
...
:::code-and-image{name="Goldilocks Version 3" src="goldilocks3-demo.gif" tabs}
```porridge
...
:::code-and-image{name="Goldilocks Version 4" src="goldilocks4-demo.gif" tabs}
```just-right-porridge
kitchen: "living-room"
