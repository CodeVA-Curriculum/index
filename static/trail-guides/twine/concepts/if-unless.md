...
:::code-and-image{name="If Example" src="simple-if-example.png"}
```
exampleVar: false
--
...
:::code-and-image{name="If Example" src="simple-if-true.png"}
```
exampleVar: true
--
...
:::code-and-image{name="Unless Example" src="simple-if-true.png"}
```
v: false
--
...
:::code-and-image{name="Unless Example" src="simple-if-example.png"}
```
var: true
--
...
:::code-and-image{name="Continue Block Example" src="continue-block-example.png"}
```
key: false
--
